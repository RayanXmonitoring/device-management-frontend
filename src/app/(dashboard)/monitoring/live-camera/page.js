...
export default function LiveCameraPage() {
  ...
  const handleStartStream = async () => {
    ...
    try {
      await dispatch(startCameraStream(selectedDevice._id)).unwrap();
      setIsStreaming(true);
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Akses kamera perangkat secara real-time</p>
        </div>
        <button
          ...
          <div className="aspect-video bg-gray-900 rounded-lg overflow-hidden relative">
            {isStreaming ? (
              ...
              <div className="flex flex-col items-center justify-center h-full text-gray-400">
                ...
                <p className="text-sm">
                  {selectedDevice ? 'Klik "Mulai Streaming" untuk melihat kamera' : 'Pilih perangkat terlebih dahulu'}
                </p>
              </div>
            )}
          </div>
